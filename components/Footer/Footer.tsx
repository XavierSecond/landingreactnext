...
export const Footer = () => {
  return (
    <div className=" w-[100vw] h-[30vh] bg-[#F5F5F7] justify-center content-center grid p-6 grid-flow-row auto-rows-max gap-4  ">
       <div className="grid grid-flow-col auto-cols-max gap-2 justify-around w-[100vw]">
            ...
            <div>
                <div className="grid grid-flow-row auto-rows-max gap-2 md:gap-4 flex-[0.6]">
                    ...
                    <h4 className="text-[#343432] font-normal text-[1rem] grid grid-flow-col auto-cols-max gap-2"><PhoneIcon className="text-[#343432] h-[1.5rem] w-[1.5rem]"></PhoneIcon> +1 (984) 335-2877</h4>
                    <h4 className="text-[#343432] font-normal text-[1rem] grid grid-flow-col auto-cols-max gap-2"><EnvelopeIcon className="text-[#343432] h-[1.5rem] w-[1.5rem]"></EnvelopeIcon> +1 (984) 335-2877</h4>
                    <h4 className="text-[#343432] font-normal text-[1rem] grid grid-flow-col auto-cols-max gap-2"><MapPinIcon className="text-[#343432] h-[1.5rem] w-[1.5rem]"></MapPinIcon>  6609 Rossford Ln, Durham NC 27713</h4>
       ...
       <div>
       <h4 className="text-[#343432] font-normal text-[1rem] w-[80vw]  text-center gap-2 mx-auto mt-3 border-t-[0.1rem] border-[#343432] pt-2">  Constuction Labor Solutions 2024 All Rights reserved © </h4>
       </div>
