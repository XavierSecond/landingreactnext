    ...
    <div className=" w-[100vw] h-[88vh] bg-[#a9c52e] bg-cover justify-center">
      <div className="grid grid-cols-2 h-full w-full">
        <div className="grid content-center grid-flow-row auto-rows-max mx-24">
            ...
            <h1 className="text-[3rem] text-[#343432] font-semibold leading-[3.3rem] w-[40vw] h-fit mx-auto w-full mb-8 content-center">About us</h1>
        ...
        <div className="h-full w-full ">
            <img className="h-full h-full m-auto object-cover shadow-2xl rounded-ss-[10rem] rounded-es-[33rem]" src="/images/carousel/02.jpg "></img>
            <img className="h-[15rem] w-[15rem] shadow-2xl m-auto rounded-full absolute top-[125rem] righ-[38rem]" src="/images/logo-competo.jpg"></img>
        </div>
