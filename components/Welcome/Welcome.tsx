    ...
    <div className=" w-[100vw] h-[100vh] bg-cover flex bg-welcome">
      <div className="grid grid-cols-2 m-auto justify-center h-full w-full]">
        <div className="grid grid-flow-row auto-rows-max text-left gap-8 h-max w-[40vw] mx-auto self-center">
          ...
          <button className="text-[1.5rem] text-white leading-8 w-max h-fit bg-[#a9c52e] font-medium px-6 py-3 rounded-xl cursor-pointer grid grid-flow-col auto-cols-max gap-2 ">See our Services<BuildingOfficeIcon className="text-white h-[2rem] w-[2rem]" ></BuildingOfficeIcon></button>
        </div>
        <img src="/images/carousel/01.jpg" className="object-cover rounded-tl-full h-full w-full shadow-xl"></img>
      </div>
    </div>
  )
}
